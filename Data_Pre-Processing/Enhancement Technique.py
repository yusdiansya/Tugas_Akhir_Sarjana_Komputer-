...
# ## path yang digunakan 
# root_path_testing = 'data/*.jpg' ## di path mana gambar akan di blend
# root_path_saving = 'blur/'  ## dimana gambar akan disave
# file_path = glob.glob(root_path_testing)
...
# ## path yang digunakan 
# root_path_testing = 'data/*.jpg' ## di path mana gambar akan di blend
# root_path_saving = 'gausianblur/'  ## dimana gambar akan disave
# file_path = glob.glob(root_path_testing)
...
# ## path yang digunakan 
# root_path_testing = 'data/*.jpg' ## di path mana gambar akan di blend
# root_path_saving = 'medianblur/'  ## dimana gambar akan disave
# file_path = glob.glob(root_path_testing)
...
## path yang digunakan 
root_path_testing = 'C/Users/ISYSRG.COM/Documents/Wisuda Bareng/Yusdiansya/All Denoising Technique/Bilateral Blur/low/*.jpg' ## di path mana gambar akan di blend
root_path_saving = 'C/Users/ISYSRG.COM/Documents/Wisuda Bareng/Yusdiansya/All Denoising Technique/Bilateral Blur/high/'  ## dimana gambar akan disave
file_path = glob.glob(root_path_testing)
...
# root_testing = ("data/*.jpg") ## untuk folder yang akan diresize
